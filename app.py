...
st.markdown("""
<style>
    /* Target the sidebar radio buttons labels */
    .stRadio > label {
        font-size: 18px; /* Increase font size */
        font-weight: bold; /* Make text bold */
        margin-bottom: 5px; /* Add some space between items */
        padding: 10px; /* Add padding for background */
        border-radius: 8px; /* Rounded corners */
        border: 1px solid transparent; /* Default transparent border */
    }

    /* Individual background colors for menu items (experimental) */
    .stRadio > label:nth-of-type(1) { /* Dashboard */
        background-color: #e6f7ff; /* Light blue */
        border-color: #91d5ff;
    }
    .stRadio > label:nth-of-type(2) { /* CNG safety & FAQs Bot */
        background-color: #f6ffed; /* Light green */
        border-color: #b7eb8f;
    }
    .stRadio > label:nth-of-type(3) { /* Savings Calculator */
        background-color: #fffbe6; /* Light yellow */
        border-color: #ffe58f;
    }
    .stRadio > label:nth-of-type(4) { /* Carbon Credits Calculator */
        background-color: #ffe6f7; /* Light pink */
        border-color: #ffadd2;
    }
    .stRadio > label:nth-of-type(5) { /* Book a Site Visit */
        background-color: #e8f9f8; /* Light turquoise */
        border-color: #87e8de;
    }
    ...
    .stRadio > label.st-dg.st-c7 {
        background-color: #bae7ff; /* A slightly darker blue for selected, for example */
        border-color: #1890ff;
    }
</style>
...
def show_dashboard(df: pd.DataFrame, alerts):
    st.header("📊 CNG Commercial Dashboard")
